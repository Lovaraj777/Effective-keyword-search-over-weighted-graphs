  ...
  <div id="container">
    ...
    <div id="content" style='margin-bottom:300px;'>
      ...
      <p align="justify">
          ...
          <table>
              <tr><th>Source</th><th>Date of Post</th><th>Post Link</th></tr>
              <%
              try{
               ResultSet r=Queries.getExecuteQuery("select * from dataset where postmessage like '%"+data+"%'");
               while(r.next()){
              ...
              <tr>
                  ...
                  <td><a href="ViewDetails.jsp?id=<%=r.getString("id")%>&keyword=<%=data%>"><%=r.getString("PostLink")%></a></td>
